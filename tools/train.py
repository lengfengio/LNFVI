...
import util.loss_func as L
from dataset.FlowRefine import FlowSeq
from models import resnet_models
from util.io import save_ckpt, load_ckpt
from util.runner_func import *
import warnings
...
parser.add_argument('--IMAGE_SHAPE', type=int, default=[448,896], nargs='+')
parser.add_argument('--RES_SHAPE', type=int, default=[448,896], nargs='+')
...
def main():
    ...
    print('train_list：',args.TRAIN_LIST)
