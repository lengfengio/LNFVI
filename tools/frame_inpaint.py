...
class DeepFillv1(object):
    def __init__(self,pretrained_model=None,image_shape=[480, 840],res_shape=None,device=torch.device('cuda:0')):
        ...
        self.deepfill.eval()
        print('### deepfill parameters:', sum(param.numel() for param in self.deepfill.parameters()))
